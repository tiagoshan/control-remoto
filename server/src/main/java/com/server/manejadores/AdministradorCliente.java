...
public class AdministradorCliente extends Thread {
    ...
    private final ActualizadorBaseDatos actualizadorBaseDatos;
        ...
        this.clienteGUI = new ClienteGUI(
            ...
            new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    contadorClicks++;
                    actualizadorBaseDatos.actualizarContadorClicks(cliente, contadorClicks);
                }
            },
            () -> {
    ...
    private void detenerGrabacion() throws Exception {
        if (grabadorPantalla != null) {
            ...
            actualizadorBaseDatos.guardarVideo(interfazServidor.obtenerIdAdmin(), cliente, grabadorPantalla.obtenerRutaArchivo());
